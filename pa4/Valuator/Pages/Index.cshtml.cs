...
public class IndexModel : PageModel
{
    ...
    public IActionResult OnPost(string text)
    {
        ...
        if(connection.IsConnected)
        {
            ...
            int similarityValue = CheckSimilarity(id, text, connection, redisDb);
            ...
            natsConnection.Publish("SimilarityCalculated", Encoding.UTF8.GetBytes(similarityEventMessage));
